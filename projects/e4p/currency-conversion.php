        ...
        <div class="inner-column">
            ...
            <form method="POST">
                ...
                <div class="input-field">
                    <input id="amount-fromID" type="number" name="amountFrom" placeholder="Euros?" min="0.01" step="0.01">
                    <label for="amount-fromID">How many euros to exchange?</label>
                </div>
                <div class="input-field">
                    <input id="rate-fromID" type="number" name="rateFrom" placeholder="Euros?" min="0.000001" step="0.000001">
