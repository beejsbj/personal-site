    ...
    <body>
        ...
        <article class=".site-main">
            <div class="inner-column">
                <h1>Resume</h1>
                <p class='lato-class'> Stuff ive done. </p>
                <?php
               ...
               <?php if (isset($exp["duties"])) {
                        ...
                        echo "<ul>";
                            ...
                            foreach ($dutiesArr as $duty) {
                                echo "<li class='lato-class'>$duty</li>";
                            }
                    ...
                    if (isset($exp["skills"])) {
                        ...
                        echo "<ul>";
                            ...
                            foreach ($skillsArr as $skill) {
                                echo "<li class='lato-class'>$skill</li>";
                            }
                ...
                if (isset($exp["specialNote"])) {
                        // code...
                         $specialNote = $exp["specialNote"];
                         echo "<blockquote class='lato-class'>
                    $specialNote
                </blockquote>";
